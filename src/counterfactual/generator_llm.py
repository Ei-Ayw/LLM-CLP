...
from src.counterfactual.prompts import PROMPT_FIXED_MAPPING, IDENTITY_SWAP_PAIRS, GROUP_KEYWORDS, detect_groups, get_swap_targets

# =====================================================
# Prompt 模板 (优先使用 shared 模块中的)
# =====================================================
PROMPT_TEMPLATE_EN = PROMPT_FIXED_MAPPING
...
def main():
    ...
    parser.add_argument("--data_dir", type=str,
                        default=str(get_project_root() / "data" / "causal_fair"))
    ...
    if not os.path.exists(data_path):
        ...
        print(f"  请先运行: python -m src.data.prepare")
        return
