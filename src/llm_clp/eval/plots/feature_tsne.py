...
from src.llm_clp.models.classifier import DebertaV3CausalFair as DebertaV3MTL
from src.llm_clp.train.baselines.vanilla import SimpleTextDataset as ToxicityDataset
from src.llm_clp.common.paths import plot_path
...
def main():
    ...
    plt.suptitle('跨身份群体的特征空间可视化', fontsize=18, fontweight='bold', y=1.02)
    plt.tight_layout()
    
    output_path = plot_path(args.output_name)
