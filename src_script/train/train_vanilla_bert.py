...
# =============================================================================
# ### 训练脚本：train_vanilla_bert.py (AMP加速版) ###
# =============================================================================
...
def main():
    parser = argparse.ArgumentParser(description="Vanilla BERT Training (AMP)")
    ...
    save_basename = f"VanillaBERT_Sample{args.sample_size}_{timestamp}"
    ...
    if torch.cuda.device_count() > 1:
        print(f"Using {torch.cuda.device_count()} GPUs for training BERT...")
