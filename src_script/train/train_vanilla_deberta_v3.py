...
def main():
    ...
    # DeBERTa V3 较耗显存，batch_size 默认设为 8，此时可以用较大的 accum_steps
    ...
    for epoch in range(args.epochs):
        ...
        # 使用 accum_steps=2 来抵消较小的 batch_size
        train_loss = train_one_epoch(model, train_loader, optimizer, scheduler, device, 2)
